...
router.patch('/user/:user/role/:role', validate('changeRole', 'params'), userAccountController.addRole);
router.delete('/user/:user/role/:role', validate('changeRole', 'params'), userAccountController.deleteRole);
